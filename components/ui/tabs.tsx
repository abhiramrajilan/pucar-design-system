  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:bg-background data-active:text-primary data-active:border-border data-active:shadow-raised dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-primary",
